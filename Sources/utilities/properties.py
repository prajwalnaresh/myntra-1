# this is used to keep all properties
...
# here we can parameterize inside the methods only the browser, url and i wait but we are
# writing it in other file config.properties file because, it is generic and will never change
